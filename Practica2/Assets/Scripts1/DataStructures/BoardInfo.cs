...
namespace Assets.Scripts.DataStructures
{
    public class BoardInfo : ICloneable
    {
        ...
        public CellInfo startCell, goalCell;
        ...
        public List<CellInfo> WalkableCells
        {
            get
            {
                return (from CellInfo cell in this.CellInfos where cell.Walkable = true select cell).ToList();
            }
        }
        ...
        private void LayoutWallAtRandom(int minWalls, int maxWalls)
        {
            ...
            while (numWalls > 0)
            {
                ...
                this.CellInfos[toTestCol, toTestRow].ChangeToNoWalkable(); //Hace desaparecer las walls si lo comentas
                numWalls--;
            }
        }
        ...
        public GameObject CreateGameObject(BoardManager boardManager)
        {
            ...
            foreach (var cellInfo in this.CellInfos)
            {
                ...
                //{
                    // ||
                    this._grid.Add(cellInfo);                  
                   //Debug.Log(cellInfo.CellId);
                //}
                //this._grid.Add(Exit);
